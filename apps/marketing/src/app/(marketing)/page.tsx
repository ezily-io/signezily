...
export default async function IndexPage() {
  ...
  return (
    <div className={cn('mt-12', fontCaveat.variable)}>
      <div className="bg-amber-100 border-l-4 border-amber-500 p-4 mb-8 text-amber-800 rounded shadow-sm">
        <p className="font-bold text-lg">⚠️ Sunset Notice / 停止營運公告</p>
        <p>Signezily will be discontinued as a public service on <strong>March 15, 2026</strong>. Thank you for your support!</p>
        <p>本產品預計於 <strong>2026 年 3 月 15 日</strong> 正式停止服務，感謝您一直以來的支持！</p>
